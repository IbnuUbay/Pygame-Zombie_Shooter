...
# bg
background = pygame.image.load('resources/images/Background image6.png')

# bg sound
mixer.music.load('resources/audios/Background.wav')
mixer.music.play(-1)
...
# player
playerImg = pygame.image.load('resources/images/Shooter.png')
playerx = 660
playery = 372
playery_change = 0
playerx_change = 0
...
#multiple enemies
enemyImg.append(pygame.image.load('resources/images/enemy1.png'))
enemyImg.append(pygame.image.load('resources/images/enemy2.png'))
enemyImg.append(pygame.image.load('resources/images/enemy3.png'))
enemyImg.append(pygame.image.load('resources/images/enemy4.png'))
enemyImg.append(pygame.image.load('resources/images/enemy5.png'))
enemyImg.append(pygame.image.load('resources/images/enemy2.png'))
...
while running:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                if bullet_state == 'ready':
                    bullet_sound = mixer.Sound('resources/audios/Bullet.wav')
    ...
    for i in range(number_of_enemies):
        ...
        if collision:
            ...
            hit_sound = mixer.Sound('resources/audios/collision.wav')
